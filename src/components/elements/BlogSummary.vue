...
export default {
    ...
    computed:{
        atitle(){ return this.calcAnim('bbbs-title-in') },
        acopy(){ return this.calcAnim('bbbs-copy-in') },
        adate(){ return this.calcAnim('bbbs-date-in') }
    },
    mounted(){
...
<style scoped>
    ...
    .bs-mobile > span:nth-child(1){
        margin-top:50px;
        margin-bottom: 15px;
        margin-left: 15px;
    }
    .bs-mobile > span:nth-child(2){
        font-family:"BB_title";
        color:#000;
        letter-spacing: 0.3px;
        font-size: 32px;
    ...
    .bs-mobile > span:nth-child(2):hover { color:#e40477; }
    .bs-mobile > span:nth-child(3){
        width: 90%;
        margin-bottom:50px;
    }
    ...
    @media (max-width: 767px) {
        ...
        .full-sum-row { display:none; }
        .split-sum-row { display:none; }
        .bs-border{ width: 100%; }
