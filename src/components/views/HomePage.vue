<template>
    <section>
        ...
        <section id="splash" ref="splash">
            <video autoplay muted loop poster="../../assets/reel.png">
                <source src="../../assets/reel.mp4" type="video/mp4">
                <source src="../../assets/reel.ogv" type="video/ogg">
            </video>
        </section>
...
<script>
    ...
    export default {
        name:'HomePage',
        components: { HomeMenu, WorkSummary, BbFooter },
        metaInfo: {
            title:'Branger_Briz',
            titleTemplate:null,
            meta: metaTags.home
        ...
        methods:{
            calcVidOpacity(){
                // console.log('calcVidOpacity',this.$refs)
            ...
            calcPageBG(){
                // console.log('calcPageBG',this.$refs)
            ...
            calcSplashHeight(){
                // console.log('calcSplashHeight',this.$refs)
            ...
            calcArrow(){
                if( this.$refs.arrow ){
                    let l = innerWidth/2 - innerWidth*.3/2
